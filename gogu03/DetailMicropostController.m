...
@interface DetailMicropostController () <UITableViewDataSource,UITableViewDelegate>
...
@implementation DetailMicropostController
...
- (void)viewDidLoad {
    ...
    CGFloat tableH=self.view.frame.size.height-130;
...
//    DetailBottomBar *detailBottomBar=[[DetailBottomBar alloc] init];
    ...
    CGFloat X=10;
    CGFloat Y=self.view.frame.size.height-110;
    CGFloat W=[UIScreen mainScreen].bounds.size.width-20;
    CGFloat H=44;
